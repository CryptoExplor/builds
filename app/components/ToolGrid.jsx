    ...
    <>
      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-4">
        <div className="flex-1">
          ...
          <div id="search-shortcut-hint" className="mt-2 text-xs text-white/50">
            Tip: Press <span className="rounded border border-white/10 px-1.5 py-0.5 font-mono text-[10px]">/</span> to jump to search
          </div>
        </div>
