 ...
 * Safe for Next.js build-time static generation
...
export function loadTools() {
  try {
    ...
    for (const file of files) {
      ...
      try {
        // Use Node.js require for synchronous loading at build time
        // Clear cache to ensure fresh reads during dev
